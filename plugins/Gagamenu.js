...
const { gaga } = require(__dirname + "/../midushgaga/zokou");
const { format } = require(__dirname + "/../midushgaga/mesfonctions");
const os = require("os");
...
gaga({ nomCom: "dashboard", categorie: "General" }, async (dest, zk, commandeOptions) => {
    let { ms, repondre, prefixe, nomAuteurMessage } = commandeOptions;
    let { cm } = require(__dirname + "/../framework/zokou");
    var coms = {};
    var mode = "public";
