const { gaga } = require('../midushgaga/gaga');
...
gaga({
  ...
  async function redeployApp() {
    try {
      ...
      await repondre("> Your bot is getting updated, wait  some minutes for the redeploy to finish! This will install the latest version of Xgaga bot.");
